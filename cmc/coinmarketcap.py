...
def getDataFor(cryptocurrencies, start_date, end_date, fields = [], myasync = False, DOWNLOAD_DIR = None):
    ...
    if myasync:
        ...
        from cmc.myasync import async_utils
...
parser.add_argument("end_date",    help="End date for the historical data retrieval. If you wish to retrieve all the "
                                        ...
                                        "'yyyy-mm-dd'.", type=str)
parser.add_argument("--myasync", help="If present, scrapes cryptocurrencies asynchronously (faster).", default = False,action='store_true')
...
def main(args=None):
    ...
    cryptocurrencies, start_date, end_date, myasync = args.currency, args.start_date, args.end_date, args.myasync

    cryptocurrencies = cryptocurrencies.split(',')

    df = getDataFor(cryptocurrencies, start_date, end_date, myasync = myasync)
